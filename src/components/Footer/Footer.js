      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <p>
            Raghu book store is an online React web application where the customer can purchase books online.
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> raghuveermustimalla@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 9182063344
            </p>
            <p>
              <i className="fa fa-home mr-3" /> Nalanda, Vijayawada
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
          ...
          <MDBCol md="4" lg="4" className="ml-lg-0">
            <div className="text-center text-md-right">
              ...
              <li className="list-inline-item">
                ...
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href='https://instagram.com/white_devil084?igshid=MzNlNGNkZWQ4Mg=='>
