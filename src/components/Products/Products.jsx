  ...
  return (
    <main className={classes.content} >
      ...
      <Carousel fade infiniteLoop useKeyboardArrows autoPlay>
        <Carousel.Item>
          <img className="d-block w-100" src={"https://repository-images.githubusercontent.com/249393487/bf5c5500-6dbc-11ea-99bb-2bed9dc4fe08"} />
          <Carousel.Caption>
            <Button
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaHt6LiSJ0W6-QMOwjRaYXH3RllrsViu3vALjNMa_UYSa_FrAffZSZWTIh&s=10"} alt="Second slide" />
          <Carousel.Caption>
            <Button
              className={classes.but}
              size="large"
